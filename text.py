useful_links = """
    - [PDM Onboarding](https://pybites.circle.so/c/pybites-developer-mindset-pdm-program/)
    - [Circle Community](https://pybites.circle.so/feed)
    - [Pybites Podcast](https://www.pybitespodcast.com/)
    - [Pybites YouTube Channel](https://www.youtube.com/@Pybites)
    - [Articles/Blog Posts](https://pybit.es/articles/)
    - [Code Clinics](https://pybites.circle.so/c/circle-coaching-calls/?topics=35656)
    - [Mindset Clinics](https://pybites.circle.so/c/circle-coaching-calls/?topics=35655)
    - [Code Challenge](https://codechalleng.es/)
    """

gh_pdm_links = """
    - [PDM Main Repository](https://github.com/pybites/PDM_KennyC)
    - [PDM Project](https://github.com/users/pybites/projects/38)
    - [PDM Issues](https://github.com/pybites/PDM_KennyC/issues)
    - [PDM Milestones](https://github.com/pybites/PDM_KennyC/milestones)
    """

gh_app_links = """
    - [Application Repository](https://github.com/kenny-chua/pdm-companion)
    - [Application Issues](https://github.com/kenny-chua/pdm-companion/issues)
    - [Application Project](https://github.com/users/kenny-chua/projects/4)
    """
...
html_code_block_style = """
    <div style="text-align: center; margin-top: 50px;">
        <div style="
            ...
            <p style="font-size: 1.5em; color: white; font-family: 'IBM Plex Sans', sans-serif; font-weight: bold; animation: blinker 5s linear infinite;">Congragulations!! 🎉 You are  PCPD-P CERTIFIED.</p>
        </div>
    </div>
    <style>
    @keyframes blinker {
...
testimonial_style = """
    <div style="
        ...
        text-align: center;
    ">
        <p style="font-size: 1.2em; font-style: italic;">{}</p>
    </div>
    """